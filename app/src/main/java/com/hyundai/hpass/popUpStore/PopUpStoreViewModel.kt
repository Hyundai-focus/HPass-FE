...
class PopUpStoreViewModel: ViewModel() {
    ...
    private fun mockData() {
        popUpStore.value = listOf(
            PopUpStoreResponse("스타벅스", "02.01(목)", "02.07(수)", "1층", "https://www.ehyundai.com/attachfiles/branch/20210209104434346.jpg"),
            PopUpStoreResponse("이디야", "02.01(목)", "02.07(수)", "2층", "https://www.ehyundai.com/attachfiles/branch/20220906035951614.jpg"),
            PopUpStoreResponse("투썸플레이스", "02.1(목)", "02.07(수)", "3층", "https://www.ehyundai.com/attachfiles/branch/20210209093808991.jpg")
        )
    }
}