...
class NewItemListAdapter(
    ...
    class NewItemListViewHolder(val binding: NewProductItemNewProductBinding) :
        RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewItemListViewHolder {
        val binding = NewProductItemNewProductBinding.inflate(
    ...
    private fun newProductDialog(item: NewItemListResponse, status: Boolean) {
